...
public class Pathfinding : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask obsctaclesLayerMask;
    ...
    public void Setup(int width, int height, float cellSize)
    {
        ...
        for (int x = 0; x < width; x++)
        {
            for (int z = 0; z < height; z++)
            {
                ...
                if(Physics.Raycast(worldPosition + Vector3.down * raycastOffsetDistance, Vector3.up, raycastOffsetDistance * 2, obsctaclesLayerMask))
                {
